...
class ScheduleFragment : BaseFragment() {
    ...
    private fun showAlterDialogAdding() {
        ...
        builder.setItems(
            ...
            when (which) {
                0 -> replaceFragment(AddScheduleFragment())
                1 -> replaceFragment(AddNoteFragment.newInstance(parentFolderId))
                2 -> replaceFragment(AddFolderFragment.newInstance(parentFolderId))
                3 -> {
                }
                4 -> {
                }
