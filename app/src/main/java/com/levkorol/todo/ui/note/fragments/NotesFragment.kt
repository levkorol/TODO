...
import com.levkorol.todo.ui.note.fragments.NotesFragment.NotesFilter.Companion.IMPORTANT_NOTES
import com.levkorol.todo.ui.note.fragments.NotesFragment.NotesFilter.Companion.NOTES_IN_SCHEDULE
import com.levkorol.todo.ui.note.fragments.NotesFragment.NotesFilter.Companion.ONLY_FOLDER
import com.levkorol.todo.ui.note.fragments.NotesFragment.NotesFilter.Companion.ONLY_NOTES
...
class NotesFragment : Fragment() {
    ...
    private fun showAlterDialog() {
        ...
        builder.setPositiveButton("Заметку") { _, _ ->
            replaceFragment(AddNoteFragment.newInstance(parentFolderId))
        }
        builder.setNegativeButton("Папку") { _, _ ->
            replaceFragment(AddFolderFragment.newInstance(parentFolderId))
        }
...
//        viewModel = ViewModelProvider(requireActivity()).get(NotesViewModel::class.java)
//        viewModel.parentFolderId = arguments?.getLong(PARENT_FOLDER, 0) ?: 0L
//        viewModel.adapter = NotesAndFoldersAdapter(activity as MainActivity)
//        viewModel.helper = navigator
//        viewModel.init()
//    }
//
//    override fun onCreateView(
...
//
//
//    private val navigator = object : Helper {
//        override fun showAddNoteFragment(parentFolderId: Long) {
//            replaceFragment(AddNoteFragment.newInstance(parentFolderId))
//        }
//        override fun showAddFolderFragment(parentFolderId: Long) {
//            replaceFragment(AddFolderFragment.newInstance(parentFolderId))
//        }
//        override fun createAlertDialogBuilder(): MaterialAlertDialogBuilder {
...
//    interface Helper {
//
//        fun showAddNoteFragment(parentFolderId: Long)
//        fun showAddFolderFragment(parentFolderId: Long)
//        fun createAlertDialogBuilder(): MaterialAlertDialogBuilder
//    }
//}